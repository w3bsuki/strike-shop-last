...
const mockSocialFeedItems: SocialFeedItem[] = [
  {
    ...
    fitScore: 95,
    caption:
      'Nailed the fit with the AR try-on! 🔥 Absolutely seamless. #OffWhiteAR #FutureOfFashion',
    likes: 1203,
    comments: 45,
  },
  {
    ...
    fitScore: 98,
    caption:
      'Virtual try-on for these Off-White™ kicks is a game-changer. Perfect fit confirmed! 👟',
    likes: 876,
    comments: 22,
  },
  {
    ...
    fitScore: 92,
    caption:
      'Loving the AR feature. Got my size right instantly. @OffWhite™ "ACCURATE"',
    likes: 540,
    comments: 15,
  },
  {
    ...
    fitScore: 96,
    caption:
      'AR fitting for pants? Yes, please! These Off-White™ cargos are 🔥. Fit is spot on.',
    likes: 992,
    comments: 33,
  },
];
