  ...
  useEffect(() => {
    const confirmEmail = async () => {
      try {
        ...
        // Create Medusa customer after email verification
        try {
          const { data: { user } } = await supabase.auth.getUser();
          if (user) {
            // Call API to create Medusa customer
          ...
          console.error('Failed to create Medusa customer:', err);
          // Don't fail the whole process if Medusa customer creation fails
        }
