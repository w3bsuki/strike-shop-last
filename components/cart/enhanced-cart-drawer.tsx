...
export function EnhancedCartDrawer() {
  ...
  return (
    <Sheet open={cart.isOpen} onOpenChange={cartActions.setCartOpen}>
      <SheetContent 
        className="w-full sm:max-w-lg p-0 flex flex-col focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900"
          ...
          <div className="flex items-center justify-between">
            ...
            <div id="cart-description" className="sr-only">
              {cart.items.length === 0 
                ...
                : `Shopping cart with ${cart.items.length} items. Total: ${formatPrice(cart.items.reduce((total, item) => {
              ...
              {cart.items.length > 0 && (
                <>
                  <Button
                    ...
                    className="focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                  >
          ...
          <>
            ...
            <div className="border-t bg-muted/50 p-6 space-y-4">
              ...
              <div className="space-y-2">
                <Button 
                  className="w-full focus:ring-2 focus:ring-gray-900 focus:ring-offset-2" 
                  size="lg"
                  ...
                  aria-describedby="checkout-button-description"
                >
                  {cart.isLoading ? 'Updating...' : 'Proceed to Checkout'}
                </Button>
                
                <div id="checkout-button-description" className="sr-only">
                  {cart.items.length === 0 
                    ? "Add items to your cart to proceed to checkout"
                    : `Proceed to checkout with ${cart.items.length} items`
                  }
                </div>
