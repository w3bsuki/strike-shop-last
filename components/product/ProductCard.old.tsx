...
export const ProductCard = React.memo(({ 
  ...
  const handleAddToCart = async (e: React.MouseEvent) => {
    ...
    // For products without size options, we can't add from card
    // Direct user to product page or quick view
    announceToScreenReader(`Opening quick view for ${product.name} to select options`, 'polite');
    openQuickView(product.id);
    toast({
      title: 'Select Options',
      description: 'Please select size and other options before adding to cart.',
    });
  };
