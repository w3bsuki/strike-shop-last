    ...
    return (
      <>
        <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
          <DrawerContent 
            className="h-[85vh] flex flex-col bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900"
            aria-labelledby="quick-view-mobile-title"
            aria-describedby="quick-view-mobile-description"
          >
            {/* Drawer Handle */}
            <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-gray-300 mt-3" />

            <div className="flex flex-col h-full overflow-hidden">
              {/* Hidden titles for mobile accessibility */}
              <VisuallyHidden>
                <h2 id="quick-view-mobile-title">Product Quick View - {product.name}</h2>
                <p id="quick-view-mobile-description">
                  View product details for {product.name} and add to cart. Price: {product.price}
                </p>
              </VisuallyHidden>
  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
        <DialogContent
          className="max-w-6xl w-full h-[85vh] min-h-[600px] p-0 gap-0 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900"
          aria-labelledby="quick-view-title"
          aria-describedby="quick-view-description"
        >
          <VisuallyHidden>
            <DialogHeader>
              <DialogTitle id="quick-view-title">Product Quick View - {product.name}</DialogTitle>
