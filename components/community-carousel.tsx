  ...
  const communityPosts: CommunityPost[] = [
    {
      ...
      caption:
        'Living for this oversized fit! Perfect for those cozy street vibes ✨ #StrikeStyle',
      likes: 1247,
      comments: 89,
    ...
    },
    {
      ...
      caption:
        'Monochrome perfection. These cargos are everything! 🖤 #MinimalVibes',
      likes: 892,
      comments: 45,
      location: 'London, UK',
    },
    {
      ...
      caption:
        "These sneakers are a statement piece! Can't stop wearing them 👟",
      likes: 2156,
      comments: 134,
      location: 'Tokyo, JP',
    },
    {
      ...
      caption:
        'Ready for any adventure in this technical masterpiece 🌆 #UrbanExplorer',
      likes: 1543,
      comments: 67,
      location: 'Berlin, DE',
    },
    {
      ...
      caption:
        'This bag completes every look. Luxury meets functionality 👜 #StrikeLuxury',
      likes: 967,
      comments: 52,
      location: 'Paris, FR',
    },
    {
      ...
      caption:
        'Expressing my creativity through fashion! This tee speaks volumes 🎨',
      likes: 1834,
      comments: 98,
  ...
  return (
    <section className="section-padding bg-gray-50">
      <div className="strike-container">
        <div className="flex justify-between items-start">
          <div>
            <SectionHeader 
              ...
              className="mb-2"
            />
            <p className="text-xs text-muted-foreground uppercase tracking-wider font-typewriter">
              Real customers, real style. Tag us @strike for a chance to be featured
            </p>
          </div>
          <div className="hidden md:flex space-x-2 pt-1">
            {canScrollLeft && (
              <button
                onClick={() => scroll('left')}
                className="p-2 border border-subtle hover:border-black transition-colors duration-200"
        ...
        <div
          ref={scrollRef}
          className="flex overflow-x-auto overflow-y-visible gap-4 pb-1 horizontal-scroll"
          style={{ maxWidth: '100%' }}
        ...
        >
          {communityPosts.map((post) => (
            <div
              key={post.id}
              className="flex-shrink-0 w-[280px] sm:w-[280px] md:w-[320px] max-w-[320px] bg-white border border-subtle overflow-hidden"
            >
              {/* Post Header */}
