...
console.log(
  'You can get it by logging in and checking localStorage.getItem("medusa_admin_token")'
);
...
async function seedData() {
  try {
    ...
    const products = [
      {
        ...
        description:
          'Premium cotton essential t-shirt with minimal Strike branding',
        type: { value: 'clothing' },
        collection_id: createdCollections[0]?.id,
        categories:
          createdCategories.length > 0 ? [{ id: createdCategories[0].id }] : [],
        status: 'published',
        options: [
      ...
      },
      {
        ...
        description:
          'Technical performance hoodie with moisture-wicking fabric',
        type: { value: 'clothing' },
        ...
        variants: [
          {
            title: 'S / Black',
            sku: 'STRIKE-HOOD-S-BLK',
            prices: [
              { amount: 7500, currency_code: 'usd' },
              { amount: 6500, currency_code: 'eur' },
            ],
            manage_inventory: true,
      ...
      },
      {
        ...
        collection_id: createdCollections[0]?.id,
        categories:
          createdCategories.length > 1 ? [{ id: createdCategories[1].id }] : [],
        status: 'published',
        options: [
        ...
        variants: [
          {
            ...
            sku: 'STRIKE-RUN-8-BW',
            prices: [
              { amount: 12000, currency_code: 'usd' },
              { amount: 10000, currency_code: 'eur' },
            ],
            manage_inventory: true,
      ...
      },
      {
        ...
        categories:
          createdCategories.length > 3 ? [{ id: createdCategories[3].id }] : [],
        status: 'published',
    ...
    console.log('\nYou can now:');
    console.log(
      '1. View products in admin panel: http://172.30.205.219:9000/app/products'
    );
