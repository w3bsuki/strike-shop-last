...
const categories = [
  {
    name: 'Sneakers',
    slug: 'sneakers',
    description: 'Premium athletic and lifestyle sneakers',
  },
  {
    name: 'Menswear',
    slug: 'menswear',
    description: "Contemporary men's clothing collection",
  },
  {
    name: 'Womenswear',
    slug: 'womenswear',
    description: "Modern women's fashion essentials",
  },
...
const productTemplates = {
  sneakers: [
    ...
    {
      name: 'Arrow Runner 2.0',
      basePrice: 590,
      sizes: ['39', '40', '41', '42', '43', '44', '45'],
      colors: ['White/Grey', 'Black/Red', 'Navy', 'Beige'],
    },
    {
      name: 'Court Classic',
      basePrice: 420,
  ...
  menswear: [
    {
      name: 'Diagonal Stripe Overshirt',
      basePrice: 845,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Black', 'Navy'],
    },
    {
      name: 'Jacquard Check Shirt',
      basePrice: 624,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  kids: [
    {
      name: 'Kids Logo Print T-Shirt',
      basePrice: 209,
      sizes: ['4Y', '6Y', '8Y', '10Y', '12Y'],
      colors: ['White', 'Black', 'Red'],
    },
    {
      name: 'Kids Diag Stripe Cap',
      basePrice: 139,
      sizes: ['One Size'],
...
function generateDetails(category) {
  const baseDetails = [
    {
      title: 'Materials',
      content: 'Premium quality materials selected for durability and comfort',
    },
    {
      title: 'Care Instructions',
      content:
        'Professional cleaning recommended. Store in dust bag when not in use.',
    },
    {
      title: 'Shipping',
      content:
        'Free express shipping on orders over £500. 2-3 business days delivery.',
    },
  ];
  ...
  const categorySpecific = {
    sneakers: {
      title: 'Technology',
      content: 'Advanced cushioning system with responsive foam midsole',
    },
    menswear: {
      title: 'Fit Guide',
      content:
        'Regular fit. Size up for a relaxed fit, size down for a slimmer silhouette.',
    },
    womenswear: {
      title: 'Styling',
      content: 'Versatile piece that transitions from day to evening wear',
    },
    kids: {
      title: 'Safety',
      content: 'Made with child-safe materials and secure fastenings',
    },
    accessories: {
      title: 'Features',
      content: 'Multiple compartments for organization and functionality',
    },
  };
...
async function seedDatabase() {
  ...
  try {
      ...
      for (const product of products) {
        ...
        const productDoc = {
          ...
          originalPrice: isOnSale
            ? Math.round(product.basePrice * 1.35)
            : undefined,
    ...
    console.log(
      '2. Run the Medusa sync script to create matching products in Medusa'
    );
